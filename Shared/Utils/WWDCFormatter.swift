...
struct WWDCFormatter {
    ...
    func formattedText() -> String {
        text.components(separatedBy: ".").joined(separator: ".\n")
    }
    func output() -> String {
        text
    }

    func outputJapanese() -> String {
        print(japanese.components(separatedBy: "\n").count)
        print(text.components(separatedBy: "\n").count)
        return japanese
    }

    func convertString() -> String {
        let content: [String] = (0...161).compactMap { index -> String? in
            let en = text.components(separatedBy: "\n")[safe: index]
            let jp = japanese.components(separatedBy: "\n")[safe: index]
